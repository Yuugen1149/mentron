...
export default function ExecomNotificationsPage() {
    ...
    const notifications = [
        { id: 1, title: 'Material Uploaded', message: 'You uploaded Digital Electronics notes', type: 'material', timestamp: '1 hour ago', read: false },
        { id: 2, title: 'New Student Registered', message: 'A new student joined ECE Year 2', type: 'system', timestamp: '3 hours ago', read: true },
    ];
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="space-y-4">
                        {notifications.map((notification) => (
                            <div key={notification.id} className={`glass-card ${!notification.read ? 'border-l-4 border-primary-cyan' : ''}`}>
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-start justify-between gap-2 mb-1">
                                            ...
                                            {!notification.read && <span className="w-2 h-2 bg-primary-cyan rounded-full flex-shrink-0 mt-2"></span>}
                                        </div>
