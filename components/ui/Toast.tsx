...
export function Toast({ message, onClose, duration = 3000 }: ToastProps) {
    ...
    return (
        <div className="fixed top-5 right-5 z-[9999] animate-slide-in">
            <div className="flex flex-row items-center justify-start w-80 p-3 bg-[#EF665B] rounded-lg shadow-[0px_0px_5px_-3px_#111] font-sans">
                <div className="w-5 h-5 mr-2 -translate-y-[2px]">
                ...
                <div className="font-medium text-sm text-white flex-1">{message}</div>
                <div className="w-5 h-5 cursor-pointer ml-auto" onClick={onClose}>
